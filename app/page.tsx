    ...
    <main className="flex min-h-screen flex-col items-center pt-[4rem] lg:pt-[6rem]">
      <div className='flex flex-col pb-[2rem] gap-y-[2rem] lg:gap-y-[1rem]'>
        ...
        <div className='flex flex-col py-1'>
          <p className='text-sm font-light text-center italic'>This application uses the Drinks API; some instructions, ingredients, and/or measurements may be written incorrectly so please make the best out of the drink details. You can always play with the ratios to make it fit your pallet.</p>
          <p className='text-sm font-bold text-center italic'>Never drink and drive and always drink responsibly. Happy Drinking!</p>
        </div>
        <SearchDrinks/>
      </div>
    </main>
